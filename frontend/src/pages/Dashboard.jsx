...
import { ShoppingBag, BookOpen, Award, MessageSquare, TrendingUp, Clock, ArrowRight, Zap, Users } from 'lucide-react';
...
const quickActions = [
  { label: 'StudySync Match', icon: '🧠', to: '/study-sync', color: 'from-green-400 to-neon-green', bg: 'bg-green-50 dark:bg-green-900/10' },
...
export default function Dashboard() {
  ...
  const statCards = [
    { label: 'Total Orders', value: stats.total_orders || 0, icon: ShoppingBag, color: 'from-orange-400 to-red-400', textColor: 'text-orange-600', bg: 'bg-orange-50', shadow: 'shadow-orange-100' },
    { label: 'Active Bookings', value: stats.active_bookings || 0, icon: BookOpen, color: 'from-sky-400 to-blue-500', textColor: 'text-sky-600', bg: 'bg-sky-50', shadow: 'shadow-sky-100' },
    { label: 'Study Groups', value: stats.total_study_groups || 0, icon: Users, color: 'from-green-400 to-emerald-500', textColor: 'text-neon-green', bg: 'bg-green-50 dark:bg-green-900/20', shadow: 'shadow-green-500/20' },
    { label: 'Complaints', value: stats.open_complaints || 0, icon: MessageSquare, color: 'from-purple-400 to-indigo-500', textColor: 'text-purple-600', bg: 'bg-purple-50', shadow: 'shadow-purple-100' },
  ];
