...
const StudySyncPage = lazy(() => import('./pages/StudySyncPage'));
const StudyGroupDashboard = lazy(() => import('./pages/StudyGroupDashboard'));
          ...
          <BrowserRouter>
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/study-sync" element={<DashboardLayout><StudySyncPage /></DashboardLayout>} />
                <Route path="/study-group/:groupId" element={<DashboardLayout><StudyGroupDashboard /></DashboardLayout>} />
                <Route path="/study-quiz/:groupId" element={<DashboardLayout><StudyQuiz /></DashboardLayout>} />
                <Route path="/study-stats" element={<DashboardLayout><StudyStats /></DashboardLayout>} />
                <Route path="*" element={<Navigate to="/dashboard" replace />} />
              </Routes>
            </Suspense>
            <AIChatbot />
