...
import {
  ...
  Bell, MessageSquare, User, LogOut, GraduationCap, ChevronLeft, ChevronRight, Users, BarChart2
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/study-sync', icon: Users, label: 'StudySync' },
  { to: '/study-stats', icon: BarChart2, label: 'Study Stats' },
